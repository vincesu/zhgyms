...
//	$.fn.agileUploaderGetOpt = function() {
//		return opts;
//	}
	...
	*/
	...
	$.fn.agileUploader.defaults = {
		...
		flashVars: {
			...
			max_post_size: (1536 * 1024 * 10),
			file_limit: -1,
			button_up:'upload/add-file.png',
			button_over:'upload/add-file.png',
			button_down:'upload/add-file.png'		
		},
		progressBarColor: '#000000',
		attachScrollSpeed: 1000,		
		removeIcon: 'upload/trash-icon.png',
		maxPostSizeMessage: '选择文件过多，请分批上传',
		maxFileMessage: '文件大小达到限制，请移除一个文件后重试',
		duplicateFileMessage: '这个文件已经被添加',
		notReadyMessage: '请等待加载完毕后再上传图片',
		removeAllText: '全部删除'
	};
